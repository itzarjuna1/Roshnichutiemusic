...
LOG_GROUP_ID = getenv("LOG_GROUP_ID", "-1003468243393").strip()
...
UPSTREAM_REPO = getenv(
    "UPSTREAM_REPO",
    "https://github.com/itzarjuna1/roshnichutiemusic",
)
...
SUPPORT_CHANNEL = getenv(
    "SUPPORT_CHANNEL", "https://t.me/who_cares_qt"
...
GITHUB_REPO = getenv("GITHUB_REPO", "https://github.com//vllm")
...
START_IMG_URL = getenv(
    "START_IMG_URL",
    "https://files.catbox.moe/zi9qyb.jpg",
)
...
PLAYLIST_IMG_URL = getenv(
    "PLAYLIST_IMG_URL",
    "https://files.catbox.moe/sjt2pe.jpg",
)

GLOBAL_IMG_URL = getenv(
    "GLOBAL_IMG_URL",
    "https://files.catbox.moe/t5fnd6.jpg",
)

STATS_IMG_URL = getenv(
    "STATS_IMG_URL",
    "https://files.catbox.moe/j6pqao.jpg",
)
...
SOUNCLOUD_IMG_URL = getenv(
    "SOUNCLOUD_IMG_URL",
    "https://files.catbox.moe/uyo2qs.jpg",
)
